...
#    <chr>             <dbl>      <dbl>   <dbl>   <dbl>
#  1 default_glm       0.513      0.320   0.501   0.112
#  2 default_rf        0.640      0.697   0.609   0.219
#  3 default_btree     0.640      0.137   0.627   0.254
#  4 default_maxent    0.603      0.521   0.596   0.218
