...
#    <chr>             <dbl>      <dbl>   <dbl>   <dbl>
#  1 default_glm       0.648      0.980   0.692   0.292
#  2 default_rf        0.543      0.907   0.711   0.347
#  3 default_btree     0.578      0.600   0.666   0.303
#  4 default_maxent    0.632      0.979   0.686   0.296
