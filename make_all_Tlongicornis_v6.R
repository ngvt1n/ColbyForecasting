...
# <chr>               <dbl>      <dbl>   <dbl>   <dbl>
# 1 default_glm       0.646      0.890   0.685   0.304
# 2 default_rf        0.596      0.784   0.662   0.323
# 3 default_btree     0.617      0.190   0.663   0.282
# 4 default_maxent    0.645      0.953   0.677   0.294
# overall: pretty good 
# tss is kind of alright: 0.2 -> 0.3, at least not negative
# do not use btree: 0.19 BI 
# varimp: MLD is the only important variable, all the other ones not very much
# this could have been caused by MLD having the most contrast in presence/background distributions
# conclusion: we should check out random environmental sampling? 
# prediction: 
# btree looks pretty reasonable tbh, it kinda just appears everywhere, super uniform
