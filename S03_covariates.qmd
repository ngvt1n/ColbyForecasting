...
model_input = read_model_input(scientificname = "Temora longicornis")
model_input
```
...
cfg = list(
  version = "v1",
  scientificname = "Temora longicornis",
...
```{r save_input_data}
write_model_input(variables, scientificname = "Temora longicornis", version = "v1")
```
