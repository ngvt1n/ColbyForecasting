...
#    <chr>             <dbl>      <dbl>   <dbl>   <dbl>
#  1 default_glm       0.515      0.660   0.554  0.103 
#  2 default_rf        0.509      0.620   0.546  0.126 
#  3 default_btree     0.527      0.591   0.532  0.0645
#  4 default_maxent    0.576      0.677   0.560  0.142 
